...
class Bid(Page):
    ...
    def vars_for_template(player):
        if player.group.treatment == True:
            ...
            my_text = "Now you have to decide which module you want to take. You can choose your priorities again and distribute 100 points between the modules. Each elective module can have 2 participants and each participant gets into 2 elective modules. The more points you give to a module, the higher the chance that you will be assigned to it."
        else:
